...
while human_move.downcase != "quit"
  ...
  if human_options.include?(human_move) == false
    ...
    puts computer_move
    if ((human_move == "rock" or human_move[0] == "r" or human_move == "1") and computer_move == "scissors")  or ((human_move == "paper" or human_move[0] == "p" or human_move == "2") and computer_move == "rock") or ((human_move == "scissors" or human_move[0] == "s" or human_move == "3") and computer_move == "paper")
      puts "You Win!"
